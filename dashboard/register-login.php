...
$sql_login = mysqli_query($koneksi, "SELECT * FROM order_pin WHERE email='$email' ");
...
<center><font color="yellow"><?PHP echo $_GET['error']; ?></font></center>
    ...
    <input type="submit" value="Next >>" name="register-login"  />
						</button>
					</div>
