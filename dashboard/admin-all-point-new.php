...
?>
<head>
  <title>All Point New | Tombo Ati </title>
</head>
...
if ($statusproses=='pending' OR $statusproses=='new'){$statusprosesxx="
...
?>
                    ...
                    <td><left><?php echo $statusprosesxx; ?></center></td>
...
if ($batas!='') {$batas2 = $_GET['batas'];} else {$batas2 = $default_batas;}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-point-new.php?halaman=$hal1&batas=$batas2\">Previous</a></li>
</ul>";
...
if ($i != $halaman){
 ...
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-point-new.php?halaman=$i&batas=$batas2\">$i</a></li>
</ul>";
}
else{ 
 echo " <ul class=\"pagination\"><li class=\"page-item active\"><a href=\"admin-all-point-new.php?halaman=$i&batas=$batas2\">$i</a></li></ul>"; 
}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-point-new.php?halaman=$hal2&batas=$batas2\">Next</a></li>
</ul>";
