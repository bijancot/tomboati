...
} elseIF ($paket!=="UPGRADE-SILVER") {
ob_start();
header("Location: index.php?error=GAGAL - GUNAKAN PIN UPGRADE SILVER");
} elseIF ($status=='0') {
ob_start();
...
$update = mysqli_query($koneksi, "UPDATE mebers SET paket='SILVER', tglupgrade=now() WHERE id='$id' ")or die(mysql_error());
$update2 = mysqli_query($koneksi, "UPDATE pin SET used='1', userid='$row[userid]', tanggal=now() WHERE pin='$pinupgrade' ")or die(mysql_error());
$insert = mysqli_query($koneksi, "INSERT INTO bonus_sponsor (userid, bonusfrom, paket, bonus, timer) VALUES ('$row[sponsor]','$row[userid]','$paket_member TO BRONZE',250000,now()) ") or die(mysqli_error());
        ...
        $bonus_sponsor_total=$query_total2['bonus_total_sponsor'];
                    ...
                    ?>
                            <div class="small-box bg-green">
                                ...
                                <a href="bonus-sponsor" class="small-box-footer">
        ...
        $total_bonus_pasangan=$query_total3['bonus_total_pasangan'];
                    ...
                    ?>
                            <div class="small-box bg-yellow">
                                ...
                                <a href="bonus-pasangan" class="small-box-footer">
...
if ($paket=='YUNIOR PRONZE' OR $paket=='BRONZE'){
    $tampil='
...
<td> 
<?php echo $tampil;?>                                 
<a href="#" class="btn btn-sm btn-warning"> Masukkan PIN Upgrade SILVER </i></a>                                 
</td>
<br><br>
                    </tr>
                  </thead>
...
?>
              ...
              ?>
                ...
                <div class="text-right">
                  <a href="testimonial-add" class="btn btn-sm btn-SUCCESS">ADD TESTIMONIAL <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div> 
              </div>
