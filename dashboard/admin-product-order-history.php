...
?>
<head>
  <title>Product Order History | Tombo Ati</title>
</head>
...
?>
                    ...
                    <td><center><a href="admin-product-order-process.php?code=<?php echo $data['code'];?>" class="<?php echo $class2;?>"><?php echo $tindakan;?></a></center></td>
                    </tr></div>
                 <?php   
              } 
              ?>
