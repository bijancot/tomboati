...
<div class="col-lg-12">
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><span class="glyphicon glyphicon-signal"></span> Point History</h3> 
                        </div>
...
if(isset($_GET['halaman']))
{
    ...
    $query1 = "SELECT * FROM hm2_pending_deposits WHERE status='processed' AND type='point' ORDER BY id DESC limit $default_index, $default_batas";
...
<a href="#" class="btn btn-sm btn-warning"><?php echo $statusprosesxx; ?><i class="fa fa-arrow-circle-right"> PROCESS</i></a>
';} else {$statusprosesxx='
<a href="#" class="btn btn-sm btn-success"><?php echo $statusprosesxx; ?><i class="fa fa-arrow-circle-right"> PROCESSED</i></a>
';}
...
?>
                    ...
                    <td align="right"><left><?php echo number_format($data_deposit['jumlah'], 0, ', ', '.');?></center></td>
...
$query2 = mysqli_query($koneksi, "select * from hm2_pending_deposits WHERE status='processed' ");
...
if ($batas!='') {$batas2 = $_GET['batas'];} else {$batas2 = $default_batas;}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-point-processed.php?halaman=$hal1&batas=$batas2\">Previous</a></li>
</ul>";
...
if ($i != $halaman){
 ...
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-point-processed.php?halaman=$i&batas=$batas2\">$i</a></li>
</ul>";
}
else{ 
 echo " <ul class=\"pagination\"><li class=\"page-item active\"><a href=\"admin-all-point-processed.php?halaman=$i&batas=$batas2\">$i</a></li></ul>"; 
}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-point-processed.php?halaman=$hal2&batas=$batas2\">Next</a></li>
</ul>";
