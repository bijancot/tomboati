...
?>
<head>
  <title>Pin Order Process BCA | Tombo Ati </title>
</head>
...
<!-- col-lg-12--> 
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="pin-upload-photo-bca.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
