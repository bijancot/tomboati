...
if(isset($_GET['halaman']))
{
    ...
    $query1 = "SELECT * FROM testimonials ORDER BY id DESC limit $default_index, $default_batas";
...
?>
                    ...
                    <td><center><?php echo $data['status'];?></center></td>
                     <td><center><a href="admin-testimonial-edit.php?userid=<?php echo $data['userid']; ?>" class="btn btn-sm btn-warning">Edit <i class="fa fa-arrow-circle-right"></i></a></center></td>
                    </tr>
</div>
                 <?php   
...
$query2 = mysqli_query($koneksi, "select * from testimonials");
...
if ($batas!='') {$batas2 = $_GET['batas'];} else {$batas2 = $default_batas;}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-testimonial.php?halaman=$hal1&batas=$batas2\">Previous</a></li>
</ul>";
...
if ($i != $halaman){
 ...
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-testimonial.php?halaman=$i&batas=$batas2\">$i</a></li>
</ul>";
}
else{ 
 echo " <ul class=\"pagination\"><li class=\"page-item active\"><a href=\"admin-testimonial.php?halaman=$i&batas=$batas2\">$i</a></li></ul>"; 
}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-testimonial.php?halaman=$hal2&batas=$batas2\">Next</a></li>
</ul>";

echo "<p>Total Record : <b>$jmldata</b> Testimonials</p>";
?>
                  <!-- </div>-->
              </div> 
              </div>
