...
$totalpembayaran=$_GET['total'];
	...
	while($row=mysql_fetch_array($result))
	{
		...
		array_push($detailproduct, array('id' => DHRYCV, 'price' => $totalpembayaran,  'quantity' => 1, 'name' => 'Order Pin Aktivasi'));
	}
...
Untuk pembayaran menggunakan Creditcard Anda dikenakan biaya tambahan 1% dari nilai nominal transaksi.
							<input type="hidden" name="nomorcc" id="nomorcc">
							<input type="hidden"name="namapemilik" id="namapemilik">
