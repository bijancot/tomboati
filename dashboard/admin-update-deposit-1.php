...
$dataTampilx = mysqli_fetch_assoc($sqlTampilx);
            ...
            ?>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="admin-update-deposit-2.php" method="post" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="userid" type="text" id="userid" class="form-control" value="<?php echo $dataTampilx['userid'];?>" readonly />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="name" type="text" id="name" class="form-control" value="<?php echo $dataTampilx['name'];?>" readonly />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Amount</label>
                              <div class="col-sm-10">
                                  <input name="unik" type="text" id="unik" class="form-control" value="<?php echo $data['unik'];?>" required />
                              </div>
                          </div>
