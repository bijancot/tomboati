...
?>
<head>
  <title>Product Order Process BNI | Tombo Ati </title>
</head>
...
<!-- col-lg-12--> 
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="product-upload-photo-bni.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="BNI" class="form-control" id="BNI" type="text" value="BNI" readonly />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="8811659000" class="form-control" id="8811659000" type="text" value="8811659000" readonly />
                              </div>
                          </div>
