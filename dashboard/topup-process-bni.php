...
?>
<head>
  <title>Topup Process BNI | Tombo Ati</title>
</head>
...
<!-- col-lg-12--> 
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="topup-upload-photo-bni.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                  <input name="id" type="hidden" id="id" class="form-control" value="<?php echo $_SESSION[id];?>" readonly="readonly" autofocus="on" />

                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Useridd</label>
                              <div class="col-sm-10">
