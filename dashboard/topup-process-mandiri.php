...
?>
<head>
  <title>Topup Process Mandiri | Tombo Ati</title>
</head>
...
<!-- col-lg-12--> 
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-book"></i> DEPOSIT PROCESS</h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="topup-upload-photo-mandiri.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="MANDIRI" class="form-control" id="MANDIRI" type="text" value="MANDIRI" readonly />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="1400588807777" class="form-control" id="1400588807777" type="text" value="1400588807777" readonly />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="PT.Harum Surga Kosmetindo" class="form-control" id="PT.Harum Surga Kosmetindo" type="text" value="PT.Harum Surga Kosmetindo" readonly />
                              </div>
                          </div>
