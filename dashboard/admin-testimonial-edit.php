...
?>
<head>
  <title>Testimonial Edit | Tombo Ati</title>
</head>
           ...
           <!-- /.row -->
                    ...
                    <!-- Main row -->
                    <?php
            $query = mysqli_query($koneksi, "SELECT * FROM testimonials WHERE userid='$username_member'");
...
<!-- col-lg-12--> 
                    ...
                    <div class="row">
                        ...
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="admin-testimonial-edit2.php" method="post" name="form1" id="form1">
...
<option value="OFF">OFF</option>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="submit" name="update-testimonial" value="Change Status"  class="btn btn-sm btn-primary"/>&nbsp;
