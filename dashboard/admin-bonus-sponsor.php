...
?>
<head>
  <title>Bonus Sponsor | Tombo Ati</title>
</head>
           ...
           <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-usd"></i> Fee Awal [<a href="excel/export_excel_bonussponsor.php">Export to Excel</a>]</h3> 
                        </div>
...
if(isset($_GET['halaman']))
{
    ...
    $query1 = "SELECT * FROM bonus_sponsor ORDER BY id DESC limit $default_index, $default_batas";
...
$query2 = mysqli_query($koneksi, "select * from bonus_sponsor");
...
if ($batas!='') {$batas2 = $_GET['batas'];} else {$batas2 = $default_batas;}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-bonus-sponsor.php?halaman=$hal1&batas=$batas2\">Previous</a></li>
</ul>";
...
if ($i != $halaman){
 ...
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-bonus-sponsor.php?halaman=$i&batas=$batas2\">$i</a></li>
</ul>";
}
else{ 
 echo " <ul class=\"pagination\"><li class=\"page-item active\"><a href=\"admin-bonus-sponsor.php?halaman=$i&batas=$batas2\">$i</a></li></ul>"; 
}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-bonus-sponsor.php?halaman=$hal2&batas=$batas2\">Next</a></li>
</ul>";
