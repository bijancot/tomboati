...
<head>
  <title>Deposit New | Tombo Ati</title>
        ...
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            ...
            <div class="table-responsive">
              ...
              $query1 = "SELECT * FROM hm2_pending_deposits WHERE status='pending' AND type='upgrade' ORDER BY date DESC limit $default_index, $default_batas";
...
';
                  ...
                  if ($dataphoto != '') {
                    $photo = "<a href=\"https://tomboatitour.biz/tomboati/backoffice/$dataphoto\" target=\"_blank\"><img src=\"https://tomboatitour.com/backoffice/$dataphoto\" width=\"15%\">";
                  } else {
                    $photo = "";
                  }
          ...
          <center>
            ...
            $query2 = mysqli_query($koneksi, "select * from hm2_pending_deposits WHERE status='pending' AND type='upgrade' ");
            ...
            echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-deposit-new.php?halaman=$hal1&batas=$batas2\">Previous</a></li>
</ul>";
            ...
            for ($i = 1; $i <= $jmlhalaman; $i++)
              ...
              if ($i != $halaman) {
                ...
                echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-deposit-new.php?halaman=$i&batas=$batas2\">$i</a></li>
</ul>";
              } else {
                echo " <ul class=\"pagination\"><li class=\"page-item active\"><a href=\"admin-all-deposit-new.php?halaman=$i&batas=$batas2\">$i</a></li></ul>";
              }
            echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-all-deposit-new.php?halaman=$hal2&batas=$batas2\">Next</a></li>
</ul>";
