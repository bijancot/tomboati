...
?>
<head>
  <title>Report All | Tombo Ati</title>
</head>
...
if(isset($_GET['halaman']))
{
    ...
    $query1 = "SELECT * FROM hm2_history ORDER BY id DESC limit $default_index, $default_batas";
...
?>
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>Debet </i></center></th>
                        <th><center>Credit </i></center></th>
            ...
            $query_user = mysqli_query($koneksi, "SELECT * FROM hm2_users WHERE id='$data[user_id];'");
...
?>
                    ...
                    <td><left><?php echo $data_user['username']; ?></center></td>
                    ...
                    <td><left><?php echo $type; ?></center></td>
...
$query2 = mysqli_query($koneksi, "select * from hm2_history");
...
if ($batas!='') {$batas2 = $_GET['batas'];} else {$batas2 = $default_batas;}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-report-all.php?halaman=$hal1&batas=$batas2\">Previous</a></li>
</ul>";
...
if ($i != $halaman){
 ...
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-report-all.php?halaman=$i&batas=$batas2\">$i</a></li>
</ul>";
}
else{ 
 echo " <ul class=\"pagination\"><li class=\"page-item active\"><a href=\"admin-report-all.php?halaman=$i&batas=$batas2\">$i</a></li></ul>"; 
}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-report-all.php?halaman=$hal2&batas=$batas2\">Next</a></li>
</ul>";
