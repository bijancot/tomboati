...
?>
<head>
  <title>Pin Order History On Process | Tombo Ati</title>
</head>
...
if(isset($_GET['halaman']))
{
    ...
    $query1 = "SELECT * FROM pin_request WHERE status='1' ORDER BY id DESC limit $default_index, $default_batas";
...
$query2 = mysqli_query($koneksi, "select * from pin_request WHERE status='1' ");
