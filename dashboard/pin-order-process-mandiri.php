...
<!-- col-lg-12--> 
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="pin-upload-photo-mandiri.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="1440091659000" class="form-control" id="1440091659000" type="text" value="4401659000" readonly />
                              </div>
                          </div>
