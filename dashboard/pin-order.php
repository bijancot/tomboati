...
<option value="">-----------------</option>
<option value="BRONZE">Bronze (Rp.750.000)</option>
<option value="SILVER">Silver (Rp.2.250.000)</option>
<option value="GOLD">Gold (Rp.5.250.000)</option>
<option value="PLATINUM">Platinum (Rp.11.850.000)</option>
<option value="">-----------------</option>
</select>
