...
<!-- col-lg-12--> 
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="pin-order-process-bca2" method="post" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="0000000000" class="form-control" id="0000000000" type="text" value="0000000000" readonly />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="MAXGOO" class="form-control" id="MAXGOOA" type="text" value="MAXGOO" readonly />
                              </div>
                          </div>
...
<textarea class="form-control" cols="100%" rows="3" name="message" value="" required />Detail Konfirmasi Transfer :</textarea>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a Mitra="pin-order-history.php" class="btn btn-sm btn-danger">Cancel </a>
                              </div>
                          </div>
