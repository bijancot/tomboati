...
?>
<head>
  <title>Pin Order Process | Tombo Ati</title>
</head>
...
<!-- col-lg-12--> 
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="pin-order-process2" method="post" name="form1" id="form1">
...
<option value="">------------------------</option>
<option value="pin-order-process-bca?code=<?php echo $data['code'];?>"> Bank BCA 440 165 9000</option>
<option value="pin-order-process-mandiri?code=<?php echo $data['code'];?>"> Bank Mandiri 144 009 165 9000</option>
<option value="pin-order-process-bni?code=<?php echo $data['code'];?>"> Bank BNI 881 165 9000</option>
<!-- 
