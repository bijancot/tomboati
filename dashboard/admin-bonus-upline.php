...
?>
<head>
  <title>Bonus Upline | Tombo Ati </title>
</head>
           ...
           <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-usd"></i> Hadiah Point [<a href="excel/export_excel_bonussponsor.php">Export to Excel</a>]</h3> 
                        </div>
...
?>
                    ...
                    <td align='right'><?php echo $data['point'];?></td>
                    <td align='right'><?php echo number_format($data['bonus'],0,",",".");?></td>
...
$query2 = mysqli_query($koneksi, "select * from bonus_titik");
