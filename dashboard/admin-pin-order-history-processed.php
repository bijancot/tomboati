...
<head>
  <title>Pin Order History On Processed | Tombo Ati</title>
</head>
...
if(isset($_GET['halaman']))
{
    ...
    $query1 = "SELECT * FROM pin_request WHERE status='2' ORDER BY id DESC limit $default_index, $default_batas";
...
?>
                    ...
                    <td><center><a href="pin-order-process.php?code=<?php echo $data['code'];?>" class="<?php echo $class2;?>"><?php echo $tindakan;?></a> <a href="pin-order-delete.php?code=<?php echo $data['code'];?>" class="<?php echo $class;?>"><?php echo $delete;?></a></center></td>
                    </tr>
...
$query2 = mysqli_query($koneksi, "select * from pin_request WHERE status='0' ");
...
if ($batas!='') {$batas2 = $_GET['batas'];} else {$batas2 = $default_batas;}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-pin-order-history-processed.php?halaman=$hal1&batas=$batas2\">Previous</a></li>
</ul>";
...
if ($i != $halaman){
 ...
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-pin-order-history-processed.php?halaman=$i&batas=$batas2\">$i</a></li>
</ul>";
}
else{ 
 echo " <ul class=\"pagination\"><li class=\"page-item active\"><a href=\"admin-pin-order-history-processed.php?halaman=$i&batas=$batas2\">$i</a></li></ul>"; 
}
 echo " 
<ul class=\"pagination\">
<li class=\"page-item\"><a href=\"admin-pin-order-history-processed.php?halaman=$hal2&batas=$batas2\">Next</a></li>
</ul>";
