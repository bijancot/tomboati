...
function pendaftaranMitra(){
  ...
  if($get_rows_username == null){
    ...
    if($get_rows_referral != null){
      ...
      VALUES('MITRA', '$createdAt', '$nomorKTP', '$email', '$name','$provinsi','$kota','$kecamatan','$address','$kodePos', '$country','$username', '$password', '$file_foto_ktp_db', '$nomorHP', '$referral')");
      ...
      VALUES('$referral', 'MITRA', '$createdAt', '$nomorKTP', '$email', '$name','$provinsi','$kota','$kecamatan','$address','$kodePos', '$country','$username', '$password', '$file_foto_ktp_db', '$nomorHP', '$idUserRegister')");
