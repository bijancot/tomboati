...
if(isset($_GET['halaman']))
{
    ...
    $query1 = "SELECT * FROM mebers WHERE updatex='1' ORDER BY id ASC limit $default_index, $default_batas";
...
$sqlsponsor = mysqli_query($koneksi, "SELECT * FROM generasi WHERE username='$username' ");
$rowsponsor = mysqli_fetch_assoc($sqlsponsor);
$sponsor = $rowsponsor['userid_sponsor'];
...
<?php
// $query = mysqli_query($koneksi, "UPDATE mebers SET sponsor='$sponsor', updatex='0' WHERE userid='$username'  ")or die(mysql_error());
?>
