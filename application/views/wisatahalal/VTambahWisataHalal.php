    ...
    <div class="container-fluid mt-n10">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="default">
                    <div class="card mb-4">
                        <div class="card-header">Form Tambah Wisata Halal <?= $tipe; ?></div>
                        <div class="card-body">
                            <!-- Component Preview-->
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <?= form_open_multipart('WisataHalal/aksiTambah/' . $tipe) ?>
                                    <div class="row">
                                        <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="imageWisata" class="custom-file-input" id="image-source" onchange="previewImage();">
