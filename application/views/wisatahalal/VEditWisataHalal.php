    ...
    <div class="container-fluid mt-n10">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="default">
                    <div class="card mb-4">
                        <div class="card-header">Form Edit Wisata Halal</div>
                        <div class="card-body">
                            <!-- Component Preview-->
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    ...
                                    ?>
                                        <?= form_open_multipart('WisataHalal/aksiEdit/' . $row['IDWISATAHALAL']) ?>
                                        <input type="hidden" name="tipeWisata" value="<?= $row['TIPEWISATA'] ?>">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="namaWisata">Nama Wisata</label>
                                                    <input name="namaWisata" class="form-control" id="namaWisata" type="text" placeholder="Masukkan Nama Wisata" value="<?= $row['NAMAWISATA']; ?>" required="" />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="maskapai" class="form-control" name="maskapai" required>
                                                        ...
                                                        foreach ($maskapai as $key) { ?>
                                                            <option value="<?php echo $key->IDMASKAPAI; ?>" <?php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input name="tanggalKeberangkatan" class="form-control" id="tanggalKeberangkatan" type="text" placeholder="Masukkan Tanggal" autocomplete="off" value="<?= $row['TANGGALKEBERANGKATAN']; ?>" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input name="doubleSheet" class="form-control" id="doubleSheet" type="text" placeholder="Masukkan Harga" required="" value="<?= $row['DOUBLESHEET']; ?>" />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="tripleSheet">Harga Triple Sheet</label>
                                                    <input name="tripleSheet" class="form-control" id="tripleSheet" type="text" placeholder="Masukkan Harga" required="" value="<?= $row['TRIPLESHEET']; ?>" />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="quadSheet">Harga Quad Sheet</label>
                                                    <input name="quadSheet" class="form-control" id="quadSheet" type="text" placeholder="Masukkan Harga" required="" value="<?= $row['QUADSHEET']; ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- decode -->
                                        ...
                                        <div class="form-group">
                                            <label for="image-source">Gambar Wisata</label>
                                            <!-- wadah preview -->
                                            <img id="image-preview-edit" src="<?= $row['IMAGEWISATA']; ?>" alt="image preview" />
                                            <div class="custom-file">
                                                <input type="file" value="<?= $row['IMAGEWISATA']; ?>" name="imageWisata" class="custom-file-input" id="image-source" onchange="previewImage();">
