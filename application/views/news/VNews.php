    ...
    <div class="container mt-n10">
        <div class="card mb-4">
            <div class="card-header">
                <a href="<?= site_url('news/tambahBerita'); ?>" class='btn btn-primary btn-sm' type='submit'>Tambah Berita</a>
            </div>
            <div class="card-body">
                <div class="datatable">
                    <?php
                    ...
                    $this->table->set_heading('No', 'Judul Berita', 'Deskripsi Berita', 'Isi Berita');
