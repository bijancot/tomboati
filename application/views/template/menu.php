<div class="nav accordion" id="accordionSidenav">
    ...
    <a class="nav-link collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseUmroh" aria-expanded="false" aria-controls="collapseUmroh">
        <i class="fas fa-mosque ml-2 mr-2 fa-lg fa-fw"></i>
        Umroh
        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
    </a>
    <div class="collapse" id="collapseUmroh" data-parent="#accordionSidenav">
    ...
    <a class="nav-link collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseHaji" aria-expanded="false" aria-controls="collapseHaji">
        <i class="fas fa-kaaba ml-2 mr-2 fa-lg fa-fw"></i>
        Haji
        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
    </a>
    ...
    <a class="nav-link collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseContent" aria-expanded="false" aria-controls="collapseContent">
        <i class="fas fa-pager ml-2 mr-2 fa-lg fa-fw"></i>
        Content
        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
    </a>
    <div class="collapse" id="collapseContent" data-parent="#accordionSidenav">
        <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
            <a class="nav-link " href="<?php echo site_url('news'); ?>">
                <i class="fa fa-newspaper ml-2 mr-2 fa-lg fa-fw"></i>
                News
            </a>
            <a class="nav-link " href="<?php echo site_url('Komunitas'); ?>">
                <i class="fa fa-users ml-2 mr-2 fa-lg fa-fw"></i>
                Komunitas
            </a>
            <a class="nav-link " href="<?php echo site_url('KataMutiara'); ?>">
                <i class="fa fa-book-open ml-2 mr-2 fa-lg fa-fw"></i>
                Kata-Kata Mutiara
            </a>
        </nav>
    </div>
    ...
    <a class="nav-link" href="<?php echo site_url('Pembayaran'); ?>">
        <i class="fas fa-dollar-sign ml-2 mr-2 fa-lg fa-fw"></i>
        Pembayaran
    </a>

    <a class="nav-link " href="<?php echo site_url('Chat'); ?>">
        <i class="fas fa-inbox ml-2 mr-2 fa-lg fa-fw"></i>
        Chat
    </a>
