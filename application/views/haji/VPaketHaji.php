                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            <div class="page-header-icon"><i class="fas fa-kaaba ml-2 fa-xs"></i></div>
                            Paket Haji&nbsp;<?= $tipe; ?>
                        </h1>
                        Daftar Paket
                    </div>
            ...
            <div class="card-body">
                <div class="datatable table-responsive">
                    ...
                    foreach ($paket as $row) {
                        ...
                        <a title="Edit Paket" href="' .  base_url("Haji/editPaket/" . $row->IDPAKET) . '" type="button" class="btn btn-warning mt-1 btn-sm"><i class="fa fa-edit"></i>
                        </a>
                    ...
                    ?>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Detail Paket <?= $row->NAMAPAKET; ?> </h5>
                                        <?php if ($row->ISSHOW == 1) {
                                        ?>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <h6 for="namaPaket">Nama Paket Haji <?= $tipe; ?></h6>
                                                    <p><?= $row->NAMAPAKET; ?></p>
                                                </div>
                                            </div>
                                            <div class="col">
                        ...
                        <div class="modal fade" id="hapusPaketModal<?= $row->IDPAKET; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Hapus Paket Haji&nbsp;<?= $tipe ?></h5>
                        ...
                        <div class="modal fade" id="aktifPaketModal<?= $row->IDPAKET; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Aktifkan Paket Haji&nbsp;<?= $tipe ?></h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                        ...
                        <div class="modal fade" id="nonAktifPaketModal<?= $row->IDPAKET; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Cabut Verifikasi Paket Haji&nbsp;<?= $tipe ?></h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
