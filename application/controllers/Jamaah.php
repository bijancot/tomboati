...
class Jamaah extends CI_Controller
{
    ...
    public function WisataHalal()
    {
        ...
        $data = array(
            'title'             => 'Jamaah Wisata Halal | Tombo Ati',
        ...
        $this->template->view('jamaah/VJamaahWisataHalal', $data);
    }

    public function aksiVerifikasiPendaftaranWH($kodePendaftaran)
    {
        //verif pendaftaran
        $this->MJamaah->verifPendaftaranJamaah($kodePendaftaran);
    ...
    public function aksiCabutVerifikasiPendaftaranWH($kodePendaftaran)
    {
        //cabut pendaftaran
        $this->MJamaah->cabutPendaftaranJamaah($kodePendaftaran);
