...
$query = mysqli_query($koneksi, "INSERT hm2_pending_deposits SET user_id='$id', amount='900000', status='pending', message='$message', gateway='MANDIRI', unik='$unik', code='$code', type='upgrade', date=now()")or die(mysql_error());
                                ...
                                <div class="card" style="min-height: 484px;">
                                  ...
                                  <input name="id" type="hidden" id="id" class="form-control" value="<?php echo $_SESSION['id'];?>" readonly="readonly" autofocus="on" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="MANDIRI" type="text" class="form-control" id="exampleInputUsername2" placeholder="Username" value="MANDIRI" readonly />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">No Rekening</label>
                                                <div class="col-sm-9">
                                                    <input name="rekening" type="text" class="form-control" id="exampleInputUsername2" value="144-00-159-77-298" readonly />
                                                </div>
                                            </div>
                                            <div class="form-group row">
