...
if (isset($_POST['update-security'])) {
    ...
    $username_dia = $_POST['username_dia'];
    ...
    if ($password_old == $passw) {
        $query = mysqli_query($koneksi, "UPDATE mebers SET passw='$password_new', passenc='$passwcode' WHERE id='$id' ") or die(mysqli_error());

        $query_tombo = mysqli_query($koneksi_tombo, "UPDATE USER_REGISTER SET PASSWORD='$password_new' WHERE USERNAME='$username_dia' ") or die(mysqli_error($koneksi_tombo));
                        ...
                        <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h2>
                                            <font color="green"><b><?php echo $_GET['status']; ?></font></b>
                                        </h2>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form class="forms-sample" action="" method="post">
                                            ...
                                            <div class="form-group row">
                                                <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Propinsi<span class="text-danger">*</span></label>
                                                <div class="col-sm-8">
                                                    <input name="propinsi" type="hidden" class="form-control" id="propinsi" />
                                                    <select class="select2-data-array browser-default form-control" id="select2-propinsi" required>
                                                        <option value="<?php echo $row['propinsi']; ?>"><?php echo $row['propinsi']; ?></option>
                                                        <option value="">-------------------</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Kota<span class="text-danger">*</span></label>
                                                <div class="col-sm-8">
                                                    <input name="kota" type="hidden" class="form-control" id="kota" />
                                                    <select class="select2-data-array browser-default form-control" id="select2-kota" required>
                                            ...
                                            <div class="form-group row">
                                                <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Kecamatan<span class="text-danger">*</span></label>
                                                <div class="col-sm-8">
                                                    <input name="kecamatan" type="hidden" class="form-control" id="kecamatan" />
                                                    <select class="select2-data-array browser-default form-control" id="select2-kecamatan" required>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <form class="forms-sample" action="" method="post">
                                            <div class="form-group row">
                                                <input type="hidden" name="username_dia" value="<?php echo $username ?>" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input name="password_old" type="password" class="form-control" id="exampleInputUsername2" placeholder="Password Lama" value="" required />
                                                </div>
                                            </div>
