...
$query = mysqli_query($koneksi, "UPDATE hm2_pending_deposits SET unik='$unik', status='pending', amount='$transfer', message='$message', gateway='BCA', date=now() WHERE code='$code' AND user_id='$id' ")or die(mysql_error());
