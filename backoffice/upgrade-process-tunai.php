...
if (isset($_POST['upgrade'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT hm2_pending_deposits SET user_id='$id', amount='900000', status='pending', message='$message', gateway='TUNAI', unik='$unik', code='$code', type='upgrade', date=now()") or die(mysql_error());
            ...
            <div class="card" style="min-height: 484px;">
                ...
                <div class="card-body">
                    <form class="forms-sample" action="" method="post">
                        ...
                        <div class="form-group row">
                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Nilai Uang Tunai</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" cols="100%" rows="3" name="message" value="" required />Detail Konfirmasi :</textarea>
                            </div>
                        </div>
